...
@RestController
@RequestMapping("/api/compra/retorno/paypal")
public class CompraPaypalController {
    ...
    @Transactional
    public String confirmaPagamento(@PathVariable(name = "idCompra") Long idCompra, @RequestBody @Valid PagamentoPayPalDto pagamentoDto) throws BindException{
